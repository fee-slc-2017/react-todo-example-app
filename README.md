This project was started with create-react-app (see below for more info on that).

To get started, run `yarn` to install the required packages, and then `yarn start` to spin up the dev server.

The components and App.css are documented, with the recommended reviewing order being:
  1. App.js
  2. TaskShow.js
  3. TaskList.js
  4. Task.js
